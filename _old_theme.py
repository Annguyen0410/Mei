...
PALETTES = {
    ...
    "minimal": {
        ...
        # espresso ink + a warm caf├⌐ accent. Default theme for new profiles.
        "MAIN_BG": "#faf7f1",
        "MAIN_BG_ALT": "#f4eee3",
        "SIDEBAR_BG": "#f5efe4",
    ...
    "latte": {
        ...
        # a caramel accent. Flat and soft ΓÇö the calm, creative daytime caf├⌐.
        "MAIN_BG": "#fdfaf4",
        "MAIN_BG_ALT": "#f6efe3",
        "SIDEBAR_BG": "#f8f1e6",
...
def dialog_qss(mode: str = "cafe-night", accent: str | None = None):
    """Stylesheet shared by all modal dialogs ΓÇö consistent with the modern main shell."""
    p = _palette(mode, accent)
    return """
    QDialog {
